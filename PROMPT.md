...
5. Always use subagents for research. Context is precious.
6. Update AGENTS.md as necessary to include build instructions. Avoid poluting it with design deicsions.
7. Anything that looks like it is actually a design decision, rather than an implementation plan, should go in docs/
8. Add additional AGENTS.md files in subdirectories as needed to provide context.
