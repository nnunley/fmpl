...
**Phase:** ITER-0004d.4 DONE 2026-05-12 (data-driven scenario runner — Rust surface; PAR-revised to defer FMPL-side runner to ITER-0004d.5). SCENARIO-0104/0105/0106 migrated to card format. SCENARIO-0106 grep #9 (Type::Tagged) authored as scenario case, closing the ITER-0004h audit gap. Next per user-confirmed sequencing: ITER-0004x (execution_tape parity gate) → ITER-0005 (Image Persistence).
**Iterations:** 13/16 done (ITER-0004h closed; ITER-0004d.4 closed). Pending: ITER-0004d.5 (FMPL-side runner; blocked on io::read_dir), ITER-0004x (execution_tape parity, NEW), 0004e, 0004f, 0004g, 0005+.
**Sentinel corpus (final, 2026-05-12 post-ITER-0004d.4):** ast_to_ir_parity 57/57 (2 ignored); scenario_0103 32/32 (1 ignored); tavern_demo 6/6; no_legacy_fmpl_syntax 16/16; diagnostics_fmpl_source_scan 32/32; canonical_pipeline_parity 8/8; opcode_rename_evidence 15/15; type_inference 13/13; scenario_runner 38/38 (NEW — 22 scenario cases + 15 comment_strip + 1 health-check); postlude_arm_contract 1/1 (NEW — relocated g3-test); **218 passed, 3 ignored across 10 fmpl-core suites**. Plus fmpl-scenario-runner (NEW crate): 27 passed across 5 suites. **Grand total: 245 tests passing**, 0 regressions. Canonical pipeline active. PARSER_EPOCH = 5. **Type::Tagged ratchet now authored as SCENARIO-0106 case 11 (expect_absent), closing the ITER-0004h audit gap via the new data-driven infrastructure.**
**Last event:** 2026-05-12 — ITER-0004h wrap-up + audit: deleted `Type::Tagged` variant + subtype arm + `tagged_subtyping` test (3 surgical edits, ~13 lines). Audit returned GAPS FOUND with 4 findings (stale progress.md sentinel count, type_inference test-count error in iteration-log, missing `Type::Tagged` structural-invariant ratchet, stale EPIC-002 epic header) — all surfaced by both auditors agreeing on the documentation drift. Fix-up landed inline. **ITER-0004 milestone CLOSED.**
